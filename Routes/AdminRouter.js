...
const { admin, adminG_signup, forgot_admin_password, adminG_changepassword, adminG_verification, view_admin_profile, Admin_About, Admin_Contact, Admin_Home, Admin_Members, Admin_Profile, admin_login, adminP_changepassword, adminP_signup, adminP_verification, change_admin_prof, change_pass_admin } = require('../Controller/AdminController');
